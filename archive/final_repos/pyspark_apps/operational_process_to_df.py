...
spark = SparkSession \
    .builder \
    .appName("ext_operational-process_10121") \
...
topic_name = "ext_operational-process_10121"
...
kafka_df = df.selectExpr("CAST(value AS STRING)") \
    ...
    .select("data.id", "data.type", "data.persistTime", "data.current.status")
kafka_df=kafka_df.withColumnRenamed("persistTime","persisttime")
...
def write_to_cassandra(batch_df, batch_id):
    try:
        batch_df.write \
          ...
          .options(table="dev_operational_process", keyspace="reporting") \
          .mode("append") \
